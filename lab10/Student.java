	...
	public void selectDB(int sId1){
		...
		try{
			...
			while(rs.next()){
				...
				//System.out.println(rs.getString(1)+"/t"+rs.getString(2)+"/t"+rs.getString(3)+"/t"+rs.getString(4)+"/t"+rs.getString(5)+"/t"+rs.getString(6)+"/t"+rs.getString(7)+"/t"+rs.getString(8)+"/t"+rs.getString(9));
				sId = rs.getInt(1);
